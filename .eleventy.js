...
const globalSiteData = {
    ...
    description:
        "This is a basic 11ty starter template with my most commonly used features and modern tooling",
    locale: "en",
    baseUrl: baseUrl,
};
...
module.exports = function (eleventyConfig) {
    ...
    return {
        dir: {
            input: "src",
            output: "_site",
            includes: "_includes", // this path is relative to input-path (src/)
            layouts: "_layouts", // this path is relative to input-path (src/)
            data: "_data", // this path is relative to input-path (src/)
        },
